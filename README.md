...
```groovy
dependencies {
    implementation 'ro.andob.outofroom:common-ddl:1.3.6'
    implementation 'ro.andob.outofroom:common-dml:1.3.6'
    implementation 'ro.andob.outofroom:binding-system-sqlite:1.3.6'
}
```
...
dependencies {
    implementation 'ro.andob.outofroom:common-ddl:1.3.6'
    implementation 'ro.andob.outofroom:common-dml:1.3.6'
    implementation 'ro.andob.outofroom:binding-latest-sqlite:1.3.6'
